...
exports.config = {
   ...
   * @env ONEAPM_APP_NAME
   */
  app_name : [ 'slow transaction'],
  /**
   * The user's license key. Must be set by per-app configuration file.
   *
   * @env ONEAPM_LICENSE_KEY
   */
  license_key : 'ClcDUFJRUVQ9e5cNFFxNWQkdV0badawJWU9QUVVUF9828AgEFQRTHQsI5e19VABOUlRJUwo=',
  //license_key : 'C1cHVVUFUAJ8e1fWTwtGXFseCEe5e70JXUpXBVQCTbce31NTHgEBHlQJ072fVARLVQBIBVE=',
  /**
